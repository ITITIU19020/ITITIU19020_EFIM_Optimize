 ...
 * several temporary sorted files and
 * 
 * merging those files.
 * 
 * @author Greg Cope
...
public class StreamSorter {
    ...
    /**
     * 
     * Reads the input io stream and splits it into sorted chunks which are written
     * to temporary files.
     * 
     * @param in
     * 
    ...
    /**
     * 
     * Reads the temporary files created by splitChunks method and merges them in a
    ...
    public void mergeChunks(String inputFile) throws IOException {
    ...
    /**
     * 
     * Delegate comparator to be able to sort the StringWrapper class. Delegates its
     * behavior to
     * 
     * the sorter field.
     * 
