...
/**
 * Example of how to run the EFIM algorithm from the source code, and save the
...
public class MainTestEFIM_saveToFile {
	...
	public static void main(String[] arg) throws IOException {
		...
		String input = "New\\spmf\\ca\\pfv\\spmf\\test\\DB_Utility.txt";
		...
		// frequent itemsets
		// ===================
		// Itemsets itemsets = algo.runAlgorithm(minutil, input, null, activateMerging,
		// maximumNumberOfTransactions, activateSubTreeUtilityPruning);
		// //==========================
